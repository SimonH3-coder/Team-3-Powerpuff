...
function AvatarWithHover({ size }) {
  ...
  return (
    <div className={`${sizeClass} rounded-full overflow-hidden border-4 border-sky shadow-md relative cursor-pointer`} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
      ...
      <div className="min-h-screen bg-white">
        <Container>
          <div className="md:hidden flex flex-col items-center pt-10 pb-16 px-6">
            ...
            <p className="text-sm font-poppins text-center text-gray-600 mt-1">Nature lover,<br />web development student</p>
            <SettingsTitle className="mt-8" />
            <div className="mt-6 w-full"><SettingsCard navigate={navigate} onLogout={handleLogout} /></div>
          </div>
