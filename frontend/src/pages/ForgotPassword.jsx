    ...
    <div className="flex h-screen w-full font-sans">
      ...
      <div className="w-full md:w-2/5 flex flex-col justify-between bg-white px-10 py-8">
        ...
        <div className="flex flex-col gap-5 w-full max-w-xs mx-auto">
          ...
          <Link
            to="/login"
            className="flex items-center gap-1.5 text-sm text-gray-400 hover:text-gray-600 transition-colors w-fit -mb-1"
          >
          ...
          {!sent ? (
            ...
            <>
              ...
              <div className="flex flex-col items-center gap-4 text-center">
                <span className="flex items-center justify-center w-14 h-14 rounded-full bg-green-100 text-green-600 text-3xl">
                  ✉️
                </span>
                <div>
              ...
              <Link
                to="/login"
                className="w-full text-center bg-green-600 hover:bg-green-700 active:bg-green-800 text-white font-semibold rounded-lg py-3 text-sm transition-colors"
              >
                Back to login
              </Link>
            </>
